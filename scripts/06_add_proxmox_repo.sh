...
echo
echo "🧹 Alte PXVIRT/Proxmox Repo-Dateien entfernen"
...
deb [arch=arm64 signed-by=/etc/apt/keyrings/pxvirt.gpg] https://mirrors.lierfang.com/pxcloud/pxvirt trixie main
REPO
